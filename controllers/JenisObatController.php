...
use app\models\JenisObatSearch;
...
class JenisObatController extends Controller
{
    ...
    {
        $searchModel = new JenisObatSearch();
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => 'Tambah Jenis Obat',
                    'content' => '<span class="text-success"> Berhasil Menambah Jenis Obat </span>',
                    'footer' =>  Html::button('Tutup', ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => 'modal']) .
    ...
    /**
     * Delete an existing JenisObat model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing JenisObat model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
